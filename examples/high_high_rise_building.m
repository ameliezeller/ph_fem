...
elems = [elems_mod; ...
        ...
        [elems_mod(:, 1:2)+48 elems_mod(:, 3)]; ...
        [elems_mod(:, 1:2)+60 elems_mod(:, 3)]; ...
        [elems_mod(:, 1:2)+72 elems_mod(:, 3)]; ...
        [elems_mod(:, 1:2)+84 elems_mod(:, 3)]];
...
elems_fe = [elems_fe; ...
            ...
            elems_fe(:,1:3)+48, elems_fe(:, 4:end); ...
            elems_fe(:,1:3)+60, elems_fe(:, 4:end); ... 
            elems_fe(:,1:3)+72, elems_fe(:, 4:end); ... 
            elems_fe(:,1:3)+84, elems_fe(:, 4:end)];
...
fixed_dof = [1:3, 6, 7:9, 12, 13:15, 18, 19:21, 24, ...
    25:27, 30, 31:33, 36, 37:39, 42, 43:45, 48];
